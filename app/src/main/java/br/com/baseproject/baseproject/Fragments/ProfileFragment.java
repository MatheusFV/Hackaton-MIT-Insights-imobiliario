...
//        manager = new RegisterManager(this);
    ...
    private void setupRecyclerView() {
        ...
        places.add(new Place("Rua Tijuco Preto, 933, apto 73","3","1500",""));
        places.add(new Place("Rua dos Pinheiros, 1090, bloco 3, apto 90","2","750",""));
        places.add(new Place("Rua Butanta,461,conjunto 21","4","1100",""));
